...
get_index_regions <- function() {
  ...
  logger::log_info("Fetching index regions.")
  ...
  logger::log_debug("fetching html from %s", dm_url)
  dm_html <- fetch_url_html(dm_url)

  logger::log_debug("extracting developing markets javascript.")
  ...
  logger::log_debug("rendering javascript.")
  ...
  logger::log_debug("extracting emerging markets javascript.")
